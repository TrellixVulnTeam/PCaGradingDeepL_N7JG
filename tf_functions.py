...
def initialize_parameters():
    ...
    W1 = tf.get_variable("W1", [25, 3833856], initializer=tf.contrib.layers.xavier_initializer(seed=1))
...
def model(X_train, Y_train, X_test, Y_test, learning_rate=0.0001,
          num_epochs=1500, minibatch_size=30, print_cost=True):
    """
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(num_epochs):
            ...
            saver.save(sess, './my-first-model', global_step=500, write_meta_graph=False)
